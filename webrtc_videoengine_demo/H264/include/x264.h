...
void x264_nal_encode( x264_t *h, unsigned char *dst, x264_nal_t *nal );
...
typedef struct
{
    ...
    unsigned char *plane[4];   /* Pointers to each plane */
} x264_image_t;
...
int x264_encoder_invalidate_reference( x264_t *, long long pts );
